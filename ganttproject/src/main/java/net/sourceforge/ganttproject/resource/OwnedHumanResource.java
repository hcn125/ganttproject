 ...
 * @author barmeier
 */
public class OwnedHumanResource implements HumanResource {
  /**
  ...
  public OwnedHumanResource(String name, int id, HumanResourceManager manager) {
    this.id = id;
    this.name = name;
    myManager = manager;
  ...
  private OwnedHumanResource(OwnedHumanResource copy) {
  ...
  public HumanResource unpluggedClone() {
    return new OwnedHumanResource(this);
  }
  ...
  private class ResourceAssignmentImpl implements ResourceAssignment {
    ...
    public HumanResource getResource() {
      return OwnedHumanResource.this;
    }
    ...
    public void setLoad(float load) {
      myLoad = load;
      OwnedHumanResource.this.fireAssignmentChanged();
    }

    /** Removes all related assignments */
    @Override
    public void delete() {
      OwnedHumanResource.this.myAssignments.remove(this);
      OwnedHumanResource.this.fireAssignmentChanged();
    }
